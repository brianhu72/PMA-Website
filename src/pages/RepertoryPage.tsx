...
const SEASONS: Season[] = [
  {
    ...
    productions: [
      ...
      { title: "Mini LGD 2022", type: "Dance" },
      { title: "Student Film Screening", type: "Film" },
      { title: "The Family Copoli", type: "Musical" },
      { title: "The Mush Hole", type: "Guest Artists" },
    ],
  },
  {
    label: "2021–22",
    mode: "plates",
    productions: [
      { title: "A Chicano's Guide to Navigation", type: "Theatre" },
      { title: "Blood, Water, Earth", type: "Guest Artists" },
      { title: "Haunted Natures, Hidden Environments", type: "Workshop" },
      { title: "Heermans McCalmon 2022", type: "Festival" },
      { title: "Locally Grown Dance 2022", type: "Dance" },
      { title: "Mini LGD", type: "Dance" },
      { title: "Reach For The Sky", type: "Theatre" },
      { title: "Saving for 17", type: "Theatre" },
      { title: "Seven Homeless Mammoths", type: "Theatre" },
      { title: "Thesis Film Screening", type: "Film" },
    ],
  },
  {
    label: "2019–20",
    mode: "plates",
    productions: [
      { title: "Cornell According to Sound", type: "Workshop" },
      { title: "Energy 10 Minute Play Festival", type: "Festival" },
      { title: "Locally Grown Dance", type: "Dance" },
      { title: "Mini LGD 2019", type: "Dance" },
      { title: "The Nether", type: "Theatre" },
      { title: "The Next Storm", type: "Theatre" },
      { title: "The Wolves", type: "Theatre" },
      { title: "There For You", type: "Theatre" },
    ],
  },
  {
    label: "2018–19",
    mode: "plates",
    productions: [
      { title: "A Meditation on Tongues", type: "Theatre" },
      { title: "Alison Van Dyke Service", type: "Workshop" },
      { title: "An Evening at the Caffe Cino", type: "Theatre" },
      { title: "Constellations", type: "Theatre" },
      { title: "Festival 24 2018", type: "Festival" },
      { title: "Heermans-McCalmon 2019", type: "Festival" },
      { title: "Locally Grown Dance", type: "Dance" },
      { title: "Mini LGDF 2018", type: "Dance" },
      { title: "Spill", type: "Theatre" },
      { title: "Storied by Space 10 Minute Play Festival", type: "Festival" },
      { title: "Tartuffe", type: "Theatre" },
      { title: "The Awakening of Spring", type: "Theatre" },
    ],
  },
  {
    label: "2017–18",
    mode: "plates",
    productions: [
      { title: "5th Centrally Isolated Film Festival", type: "Film" },
      { title: "Bad Jews", type: "Theatre" },
      { title: "Climates of Change", type: "Dance" },
      { title: "Containment Dance", type: "Dance" },
      { title: "Hamlet Wakes Up Late", type: "Theatre" },
      { title: "Heermans-McCalmon 2018", type: "Festival" },
      { title: "LGD Copy and Paste Slivers", type: "Dance" },
      { title: "Locally Grown Dance", type: "Dance" },
      { title: "Mr. Burns A Post Electric Play", type: "Theatre" },
      { title: "Spring 2018 Thesis Film Screenings", type: "Film" },
      { title: "The Caucasian Chalk Circle", type: "Theatre" },
      { title: "The Loneliness Project", type: "Theatre" },
      { title: "Unbound 10 Minute Play Festival", type: "Festival" },
      { title: "We Tried to Stop and We Can't", type: "Theatre" },
    ],
  },
  {
    label: "2016–17",
    mode: "plates",
    productions: [
      { title: "10 Minute Play Festival 2016", type: "Festival" },
      { title: "Baltimore", type: "Theatre" },
      { title: "Eurydice", type: "Theatre" },
      { title: "Festival 24", type: "Festival" },
      { title: "Heermans-McCalmon 2017", type: "Festival" },
      { title: "Life Sentence", type: "Theatre" },
      { title: "Locally Grown - Captured Spaces", type: "Dance" },
      { title: "Mini LGDF 2016", type: "Dance" },
      { title: "Never Fight a Shark in Water", type: "Theatre" },
      { title: "The Baltimore Waltz", type: "Theatre" },
      { title: "The Trestle at Pope Lick Creek", type: "Theatre" },
      { title: "Two Truths and Allie", type: "Theatre" },
      { title: "Walking with 'Trane", type: "Dance" },
    ],
  },
  {
    label: "2015–16",
    mode: "plates",
    productions: [
      { title: "All God's Chillun Got Wings", type: "Theatre" },
      { title: "Complete Works of William Shakespeare Abridged Revised", type: "Theatre" },
      { title: "Dis Connected Ten Minute Plays", type: "Festival" },
      { title: "Heermans-McCalmon 2016", type: "Festival" },
      { title: "LGDF Loss, Denial, and Desire 2016", type: "Dance" },
      { title: "Mini LGDF 2015", type: "Dance" },
      { title: "On The Verge", type: "Theatre" },
      { title: "The Counter Factual Dance Concert", type: "Dance" },
      { title: "The Memory Project", type: "Guest Artists" },
      { title: "The Secret in The Wings", type: "Theatre" },
      { title: "Twentyhood", type: "Theatre" },
      { title: "Waiting for Godot (Yiddish)", type: "Theatre" },
    ],
  },
  {
    label: "2014–15",
    mode: "plates",
    productions: [
      { title: "24 Hour Playfest 2014", type: "Festival" },
      { title: "AGIT Lab", type: "Workshop" },
      { title: "Blood Wedding", type: "Theatre" },
      { title: "Dancing Hip Hop Symposium", type: "Workshop" },
      { title: "Don Fredericksen Tribute", type: "Workshop" },
      { title: "Heermans-McCalmon 2015", type: "Festival" },
      { title: "LGDF Sensorial Extracts", type: "Dance" },
      { title: "Still Life Staged Reading", type: "Theatre" },
      { title: "Ten Minute Playfest", type: "Festival" },
      { title: "The Glass Menagerie", type: "Theatre" },
      { title: "The Knights of Doom", type: "Theatre" },
      { title: "The Mineola Twins", type: "Theatre" },
      { title: "The Women of Lockerbie", type: "Theatre" },
    ],
  },
  {
    label: "2013–14",
    mode: "plates",
    productions: [
      { title: "24 Hour Playfest 2013", type: "Festival" },
      { title: "A Lie of The Mind", type: "Theatre" },
      { title: "Body Against Body", type: "Dance" },
      { title: "Fall Dance Theatre Concert", type: "Dance" },
      { title: "Gruesome Playground Injuries", type: "Theatre" },
      { title: "Heermans-McCalmon 2014", type: "Festival" },
      { title: "In the Middle of the Night", type: "Theatre" },
      { title: "LGDF Cultivating Space", type: "Dance" },
      { title: "Ten Minute Playfest", type: "Festival" },
      { title: "Titus Andronicus", type: "Theatre" },
    ],
  },
  {
    label: "2012–13",
